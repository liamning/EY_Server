...
public class VotingResultInfo
{
    ...
    public class FieldName {
        ...
        public const string AbstentionNo = "AbstentionNo";
        public const string AbstentionPct = "AbstentionPct";
        public const string AbstentionAmt = "AbstentionAmt";
        public const string AbstentionAmtPct = "AbstentionAmtPct";
